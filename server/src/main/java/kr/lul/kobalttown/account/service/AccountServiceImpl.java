...
import kr.lul.kobalttown.account.jpa.entity.AccountPrincipalEmailEntity;
import kr.lul.kobalttown.account.service.params.*;
import kr.lul.kobalttown.exception.DataNotExistException;
import kr.lul.kobalttown.message.exception.MessageException;
import kr.lul.kobalttown.message.service.MessageService;
import kr.lul.kobalttown.message.service.params.EmailAddress;
import kr.lul.kobalttown.message.service.params.TemplateEmailMessageParams;
import kr.lul.kobalttown.message.service.params.TemplateMessageParams;
